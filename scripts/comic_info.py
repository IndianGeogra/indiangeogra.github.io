...
info_data = [\
	     ...
	     Comic(35, u'Улитка на склоне Фудзи', '150516', 'h'),

	     Comic(36, u'Дачный уголок', '280516', 'v'),
	     Comic(37, u'Дерево', '210516', 'v'),
             Comic(38, u'Метеобудка', '290616', 'v'),
             Comic(39, u'Китайская фантазия II', '060816', 'v', True)
]
